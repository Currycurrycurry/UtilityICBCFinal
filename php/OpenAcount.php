...
$timeN = date("His").PHP_EOL;
 ...
 $APIGW_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCwFgHD4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB";
		...
		// $APIGW_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCwFgHD4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB";		
		 $request = array(
          		"serviceUrl" => 'https://apisandbox.dccnet.com.cn/api/settlement/account/V1/open',
          		"method" => 'POST',
          		"isNeedEncrypt" => false,
          		"biz_content" => array(
					"corp_no"=>"123456799",
					...
					"corp_date"=>$dateN,
					"corp_serno"=>1234567,
					"out_service_code"=>"openaccount",
					"corp_cis_no"=>"110110198801031115",
					"corp_medium_id"=>"110110198801031115",
					"bind_medium"=>"6212880200000010294",
					"cert_type"=>"0",
					"cert_no"=>"110110198801031115",
					"cust_name"=>"测试三",
					"mobile_no"=>"18922222222",
					"notify_addr"=>"localhost",
					"bind_medium_hash"=>md5('6212880200000010294')
				)
