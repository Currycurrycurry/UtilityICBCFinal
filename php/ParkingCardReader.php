	...
	$APIGW_PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCwFgHD4kzEVPdOj03ctKM7KV+16bWZ5BMNgvEeuEQwfQYkRVwI9HFOGkwNTMn5hiJXHnlXYCX+zp5r6R52MY0O7BsTCLT7aHaxsANsvI9ABGx3OaTVlPB59M6GPbJh0uXvio0m1r/lTW3Z60RU6Q3oid/rNhP3CiNgg0W6O3AGqwIDAQAB";		
		$request = array(
            ...
            if($respObj["return_code"] == 0){ //sucess
            	 echo $respObj["plate_str"];
			}
		
		
		// $client = new DefaultIcbcClient($APP_ID, $MY_PRIVATE_KEY, $APIGW_PUBLIC_KEY);
        // $request = new ImagerecognitionObjectPlateRequestV1();        
        // $request.setServiceUrl("https://gw-api-iicamp.dccnet.com.cn//api/imagerecognition/object/plate/V1");
        // $bizContent = new ImagerecognitionObjectPlateRequestV1Biz();
        // $bizContent.setFileName("1.jpg");
        ...
        // try {
            ...
            // if ($response.isSuccess() ) {
                //业务成功处理
                // Assert.assertEquals(response.getReturn_code(), 100);
            // } else {
                //失败
            // }        
